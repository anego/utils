...
public class JsonUtilsTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        JsonElement jsonvalue = jsonRoot.get("api_data");
        assertThat(jsonvalue, notNullValue());
        assertThat(Boolean.valueOf(jsonvalue.isJsonObject()), is(Boolean.TRUE));

        JsonObject dataAray = jsonvalue.getAsJsonObject();
        assertThat(dataAray, notNullValue());

        mstship = dataAray.getAsJsonArray("api_mst_ship");
        assertThat(mstship, notNullValue());
        assertThat(Boolean.valueOf(mstship.isJsonNull()), is(Boolean.FALSE));
